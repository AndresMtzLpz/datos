...
BASE_DIR = "../10mt3/"  # directorio donde están las carpetas resultados10m6_X
PORCENTAJES = [f"resultados10mt3_{i}" for i in range(10, 101, 10)]
OUTPUT_FILE = "distancias_wasserstein_10mt3.csv"
