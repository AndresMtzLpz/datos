...
BASE_DIR = "../4mt3/"  # directorio donde están las carpetas resultados10m6_X
PORCENTAJES = [f"resultados4mt3_{i}" for i in range(10, 101, 10)]
OUTPUT_FILE = "distancias_wasserstein_4mt3.csv"
