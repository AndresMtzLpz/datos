...
BASE_DIR = "../5mt2/"  # directorio donde están las carpetas resultados10m6_X
PORCENTAJES = [f"resultados5mt2_{i}" for i in range(10, 101, 10)]
OUTPUT_FILE = "distancias_wasserstein_5mt2.csv"
