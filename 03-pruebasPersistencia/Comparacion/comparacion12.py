...
BASE_DIR = "../10mt5/"  # directorio donde están las carpetas resultados10m6_X
PORCENTAJES = [f"resultados10mt5_{i}" for i in range(10, 101, 10)]
OUTPUT_FILE = "distancias_wasserstein_10mt5.csv"
