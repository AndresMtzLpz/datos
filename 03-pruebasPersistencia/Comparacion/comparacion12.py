...
BASE_DIR = "../10mt4/"  # directorio donde están las carpetas resultados10m6_X
PORCENTAJES = [f"resultados10mt4_{i}" for i in range(10, 101, 10)]
OUTPUT_FILE = "distancias_wasserstein_10mt4.csv"
