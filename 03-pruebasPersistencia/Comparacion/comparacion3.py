...
# 📁 Crear y abrir archivo de salida
output_file = "distancias_wasserstein_todas_5m.csv"
with open(output_file, mode="w", newline="") as f_out:
    ...
    for prefijo in prefijos:
        ...
        # 🧹 Liberar memoria por prefijo
        del persistencias_por_dir

print(f"✅ Distancias calculadas y guardadas en {output_file}")
